							...
							<div class="pb-5">
								<div class="mb-0.5 text-[12.5px] text-neutral-600 dark:text-neutral-400">
									...
									{#if message.model_used}
										<span
											class="cursor-help text-neutral-500 underline decoration-neutral-400 decoration-dotted"
									...
									{#if message.executed_node_id && message.executed_node_id !== myNodeId}
										<span
											class="cursor-help text-neutral-500 underline decoration-neutral-400 decoration-dotted"
											title="This reply ran on a different device in your synced workspace (id: {message.executed_node_id}), not this one."
										>
									...
									{#if message.served_model}
										<span
											class="cursor-help text-agent-magenta-700 underline decoration-agent-magenta-400 decoration-dotted dark:text-agent-magenta-400"
